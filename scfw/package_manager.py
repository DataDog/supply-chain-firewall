...
class UnsupportedVersionError(Exception):
    ...
    handles this exception gracefully, emitting an error log that states what occurred
    along with any error message attached to the `UnsupportedVersionError` exception.
    """
    pass
